...
if st.session_state["Q11_p1"] == 2.1:  
    ...
    st.write("우선 몫을", st.session_state['y11_2_p1'], "까지만 구한 후 답을 입력해봅시다.")
    Q11_easy_Text = f"연습 11-1. {st.session_state['a11_p1']} \u00F7 {st.session_state['b11_p1']}의 몫을 {st.session_state['y11_2_p1']}까지만 구하시오."
...
if st.session_state["Q11_p1"] == 3.1:  
    ...
    st.write("그렇다면 자연수의 나눗셈으로 바꾼 후 몫을", st.session_state['y11_2_p1'], "까지만 구한 후 답을 입력해봅시다.")
    Q11_easy_Text_2 = f"연습 11-1. {st.session_state['a11__1']} \u00F7 {st.session_state['b11__1']}의 몫을 {st.session_state['y11_2_p1']}까지만 구하시오."
...
if st.session_state["Q11_p2"] == 2.1:  
    st.write("몫을 반올림하여 구하는 데 어려움이 있는 것 같군요.")
    st.write("우선 몫을", st.session_state['y11_2_p2'], "까지만 구한 후 답을 입력해봅시다.")
    Q11_easy_Text_p2 = f"연습 11-2. {st.session_state['a11_p2']} \u00F7 {st.session_state['b11_p2']}의 몫을 {st.session_state['y11_2_p2']}까지만 구하시오."
...
if st.session_state["Q11_p2"] == 3.1:  
    ...
    st.write("그렇다면 자연수의 나눗셈으로 바꾼 후 몫을", st.session_state['y11_2_p2'], "까지만 구한 후 답을 입력해봅시다.")
    Q11_easy_Text_2_p2 = f"연습 11-2. {st.session_state['a11__2']} \u00F7 {st.session_state['b11__2']}의 몫을 {st.session_state['y11_2_p2']}까지만 구하시오."
