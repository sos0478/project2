...
if st.session_state["Q12"] == 2.1:  
    ...
    st.write("우선 몫을", st.session_state['y12_2'], "까지만 구한 후 답을 입력해봅시다.")
    Q12_easy_Text = f"12. {st.session_state['a12']} \u00F7 {st.session_state['b12']}의 몫을 {st.session_state['y12_2']}까지만 구하시오."
...
if st.session_state["Q12"] == 3.1:  
    ...
    st.write("그렇다면 자연수의 나눗셈으로 바꾼 후 몫을", st.session_state['y12_2'], "까지만 구한 후 답을 입력해봅시다.")
    Q12_easy_Text_2 = f"12. {st.session_state['a12__']} \u00F7 {st.session_state['b12__']}의 몫을 {st.session_state['y12_2']}까지만 구하시오."
...
if st.session_state["Q12"] == 4:
    ...
    st.write(f"{st.session_state['a12__']} \u00F7 {st.session_state['b12__']}의 몫을 {st.session_state['y12_2']}까지만 구하면 답은 {st.session_state['right_answer4']}가 됩니다.")
